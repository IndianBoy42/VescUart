...
#define VAL_MASK_TEMP_MOSFET ((uint32_t)1 << 0)
#define VAL_MASK_TEMP_MOTOR ((uint32_t)1 << 1)
#define VAL_MASK_AVG_MOTOR_CURRENT ((uint32_t)1 << 2)
#define VAL_MASK_AVG_INPUT_CURRENT ((uint32_t)1 << 3)
#define VAL_MASK_AVG_IQ ((uint32_t)1 << 4)
#define VAL_MASK_AVG_ID ((uint32_t)1 << 5)
#define VAL_MASK_DUTY ((uint32_t)1 << 6)
#define VAL_MASK_RPM ((uint32_t)1 << 7)
#define VAL_MASK_INP_VOLTAGE ((uint32_t)1 << 8)
#define VAL_MASK_AMP_HOURS ((uint32_t)1 << 9)
#define VAL_MASK_AMP_HOURS_CHARGED ((uint32_t)1 << 10)
#define VAL_MASK_WATT_HOURS ((uint32_t)1 << 11)
#define VAL_MASK_WATT_HOURS_CHARGED ((uint32_t)1 << 12)
#define VAL_MASK_TACHOMETER ((uint32_t)1 << 13)
#define VAL_MASK_TACHOMETER_ABS ((uint32_t)1 << 14)
#define VAL_MASK_ERROR ((uint32_t)1 << 15)
#define VAL_MASK_PID_POS ((uint32_t)1 << 16)
#define VAL_MASK_ID ((uint32_t)1 << 17)
